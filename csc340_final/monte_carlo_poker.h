...
class Monte {
    ...
    public:
        ...
        */
        void sim(std::vector<std::vector<Card*> >& playersHands, std::vector<Card*>& com, unsigned int nc, unsigned int np, unsigned int it, std::vector<std::vector<int> >* results);

    private:

        /* make static players & com_cards cards*/
        void make_vectors(std::vector<std::vector<Card*> >& playersHands, std::vector<Card*>& com);
